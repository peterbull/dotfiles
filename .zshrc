...
echo 'alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"' >> ~/.zshrc
...
alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"
alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"
alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"
alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"
alias gfpb="read \"yn?Force push current branch? (y/n): \"; [[ \$yn == [Yy]* ]] && git push origin -u \$(git branch --show-current) --force-with-lease"
